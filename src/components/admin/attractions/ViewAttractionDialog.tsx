                ...
                <div className="flex flex-col gap-y-2 flex-1 pr-4">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2 shrink-0">
                      ...
                      <Badge
                        variant={attraction.isActive ? 'default' : 'secondary'}
                      >
                      ...
                      {attraction.images.map((image, index) => (
                        ...
                        >
                          <CldImage
                            src={image.url}
                            alt={
                              image.alt || `${attraction.title} ${index + 1}`
                            }
                            fill
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        <p>
                          Adult: Rp{' '}
                          {attraction.ticketPrice.toLocaleString('id-ID')}
                        </p>
                        {attraction.ticketPriceChild && (
                          <p>
                            Child: Rp{' '}
                            {attraction.ticketPriceChild.toLocaleString(
                              'id-ID'
                            )}
                          </p>
                        )}
